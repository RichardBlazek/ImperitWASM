...
namespace ImperitWASM.Client.Data
{
	...
	public sealed record LoginResult(Session S, int I, long G);
	public sealed record MoveCmd(string P, string Key, int From, int To, ImmutableArray<int> Counts, long Game);
	public sealed record MoveData(int F, int T, long G);
	...
	public sealed record PurchaseCmd(string P, string Key, int L, long G);
	...
	public sealed record RecruitCmd(string P, string Key, int Province, ImmutableArray<int> Counts, long G);
	...
	public sealed record RegisteredPlayer(string N, string P, int S, long G);
